...
/**
 * The “client” of BLE. It’s able to scan for and establish
 * connections to peripherals. Can be obtained from
 * {@link BleManager#getAdapters()}.
 */
public class Adapter implements AutoCloseable {
     ...
     *
     * <p>See {@link Adapter#startScan(List)} for more
     * details.
     *
     ...
     *
     * <p>This scan will generally continue until explicitly
     * stopped, although this may depend on your Bluetooth
     * adapter. Discovered devices will be announced to
     * subscribers of events and will be available via
     * {@link Adapter#getPeripherals()}. The filter can be
     * used to scan only for specific devices.
     *
     * <p>While some implementations might ignore (parts of)
     * the filter and make additional devices available,
     * other implementations might require at least one filter
     * for security reasons. Cross-platform code should
     * provide a filter, but must be able to handle devices,
     * which do not fit into the filter.
     *
     * @param targetUuids The UUIDs to be filtered into the
     *                    result
     * @return Whether the scan is successful
     */
    ...
    /**
     * Returns the list of {@link Peripheral}s that have
     * been discovered so far.
     *
     * <p>Note that this list may contain peripherals that
     * are no longer available.
     *
     * @return The list of {@link Peripheral}s that have
     * been discovered so far
     */
